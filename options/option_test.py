...
# Data specifications
parser.add_argument('--data_dir', type=str, default='C:/Project/DCEDSR/dataset',
...
parser.add_argument('--betag_min', type=float, default=0.2,
                    help='')
parser.add_argument('--betag_max', type=float, default=2.0,
                    help='')
parser.add_argument('--betap_min', type=float, default=1.0,
                    help='')
parser.add_argument('--betap_max', type=float, default=1.0,
                    help='')
...
parser.add_argument('--project_path', type=str, default='C:/Project/AACL',
                    help='project path')
...
parser.add_argument('--model_name', type=str, default='AACL',
