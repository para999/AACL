...
parser.add_argument('--std_max', type=float, default=2.0,
                    help='')
# JPEG
parser.add_argument('--jpeg_min', type=float, default=60,
                    help='')
...
parser.add_argument('--project_path', type=str, default='E:/Project/AACL',
                    help='project path')
...
parser.add_argument('--epochs_dp', type=int, default=100,
